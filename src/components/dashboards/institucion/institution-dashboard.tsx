        ...
        <div className="relative mx-auto w-full max-w-6xl px-6 pt-5 pb-16">
          <header className="flex items-center justify-between text-background/90">
            <div className="flex items-center gap-4">
              <div className="inline-flex items-center gap-3 rounded-full bg-background/15 px-5 py-2.5 backdrop-blur">
                <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-background/15">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <path
                      d="M3 12c2.5-2 4.7-2 7 0s4.5 2 7 0 4.5-2 7 0"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
                    />
                    <path
                      d="M4 16c2-1.6 4-1.6 6 0s4 1.6 6 0 4-1.6 6 0"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
                      opacity="0.75"
                ...
                <span className="text-sm font-semibold">{mockClub.name}</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3.5 text-sm font-medium">
              ...
              <div className="inline-flex items-center gap-2.5 rounded-full bg-background/15 px-4 py-2.5 backdrop-blur">
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-background/15 text-background">
                ...
                <span className="hidden sm:inline">{mockClub.name}</span>
              </div>
            </div>
          </header>
